#ifndef DATTO_CLIENT_UNSYNCED_SECTOR_MANAGER_SECTOR_INTERVAL_H_
#define DATTO_CLIENT_UNSYNCED_SECTOR_MANAGER_SECTOR_INTERVAL_H_
...
#endif //  DATTO_CLIENT_UNSYNCED_SECTOR_MANAGER_SECTOR_INTERVAL_H_
