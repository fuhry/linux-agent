#ifndef DATTO_CLIENT_BACKUP_STATUS_TRACKER_BACKUP_STATUS_TRACKER_H_
#define DATTO_CLIENT_BACKUP_STATUS_TRACKER_BACKUP_STATUS_TRACKER_H_
...
#endif //  DATTO_CLIENT_BACKUP_STATUS_TRACKER_BACKUP_STATUS_TRACKER_H_
