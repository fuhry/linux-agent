...
void protobuf_AssignDesc_t1_2eproto() {
  ...
  static const int TestMessage_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TestMessage, txtmsg_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TestMessage, stamp_),
  };
...
void protobuf_AddDesc_t1_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\010t1.proto\",\n\013TestMessage\022\016\n\006txtmsg\030\001 \002("
    "\t\022\r\n\005stamp\030\002 \002(\003", 56);
...
#ifndef _MSC_VER
const int TestMessage::kTxtmsgFieldNumber;
const int TestMessage::kStampFieldNumber;
#endif  // !_MSC_VER
...
const TestMessage& TestMessage::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_t1_2eproto();  return *default_instance_;
}
